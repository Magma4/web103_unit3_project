    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                // Dynamically map venues instead of hardcoding indexes
                const venueMap = {}
                locationsData.forEach((loc) => {
                    venueMap[`venue${loc.id}`] = loc.name;
                });

                setVenueNames({
                    venue1: venueMap.venue1 || 'Loading...',
                    venue2: venueMap.venue2 || 'Loading...',
                    venue3: venueMap.venue3 || 'Loading...',
                    venue4: venueMap.venue4 || 'Loading...'
                })
                setListeners()
            }
            catch (error) {
